...
<br><br>
[Download Windows Server App](https://drive.google.com/file/d/1MOHLHYeqwyu88tilU3LuwtClniOyEfKr/view?usp=sharing). (Download and install installerclient.exe file. Then you can execute with created executable server file) 
